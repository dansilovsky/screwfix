...
/**
 * ArroundArray iterates arround array. If starting position is set to non zero 
 ...
 */
class ArroundIterator implements \Iterator {
	 ...
	 * 
	 * @param int $position
	 * @throws \Dan\ArroundIterator_OutOfScope_Exception
	 */
	...
	{		
		...
		{
			throw new \Dan\ArroundIterator_OutOfScope_Exception('Given start position is out of scope.');
		}		
	}
}
